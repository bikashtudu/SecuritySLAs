service_mon(acpid,active,ubuntu,vm2).
service_mon(bluetooth,active,ubuntu,vm2).
service_mon(acpid,inactive,ubuntu,vm2).
...
ser_provided(acpid,[active],[ubuntu],[vm2]).
ser_provided(bluetooth,[active],[ubuntu],[vm1,vm2]).
