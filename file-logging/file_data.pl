file_mon(syslog,sys_write,prasad,vm2).
file_mon(syslog,sys_read,prasad,vm2).
...
file_provided(sys,[sys_read],[prasad],[vm2]).
file_provided(syslog,[sys_read,sys_write],[prasad],[vm1,vm2]).
